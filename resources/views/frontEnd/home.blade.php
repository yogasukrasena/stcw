...
@section('content')
    ...
    <div class="hero-wrap js-fullheight" style="background-image: url({{ url('frontend/images/bg_1.jpg') }});" data-stellar-background-ratio="0.5">
      ...
      <div class="container">
        <div class="row justify-content-center mb-5 pb-3">
          <div class="col-md-12 text-center heading-section heading-section-light ftco-animate">
            <h2 class="mb-2"><span class="px-4">About ST.Cakra Werdi</span></h2>
            <span class="subheading">Tentang dan Sejarah</span>
          </div>
        </div>
        <div class="row d-flex sermon-wrap">
          <div class="col-md-6 d-flex align-items-stretch ftco-animate">
            <div class="img" style="background-image: url({{ url('frontend/images/sermon-1.jpg') }});"></div>
          </div>
    ...
    <section class="ftco-section testimony-section" style="background-image: url({{ url('frontend/images/bg_3.jpg') }});">
    	<div class="overlay"></div>
      <div class="container">
        <div class="row justify-content-center mb-5 pb-3">
        ...
        <div class="row ftco-animate">
          <div class="col-md-12">
            <div class="carousel-testimony owl-carousel ftco-owl">
              ...
              <div class="item">
                <div class="testimony-wrap text-center py-4 pb-5">
                  <div class="user-img mb-4" style="background-image: url({{ url('frontend/images/person_4.jpg') }})">
                    <span class="quote d-flex align-items-center justify-content-center">
                      <i class="icon-quote-left"></i>
                    </span>
                  </div>
    ...
    <section class="ftco-section ftco-no-pt ftco-no-pb">
    	<div class="container">
    		<div class="row">
	          ...
	          <div class="event-wrap d-md-flex ftco-animate">
	          	<div class="img"style="background-image: url({{ url('frontend/images/sermon-2.jpg') }});"></div>
	          	<div class="text pl-md-5">
	          		<h2 class="mb-3"><a href="sermons.html">Know Jesus Christ Better Through Lines</a></h2>
	          		<div class="meta">
		  						<p>
    			...
    			<div class="col-lg-4 d-flex align-items-stretch">
    				<div class="subsermon p-5">
    					...
    					<div class="sermon-wrap mb-4 ftco-animate">
	    					<a href="sermons.html" class="img mb-3" style="background-image: url({{ url('frontend/images/event-1.jpg') }});"></a>
	    					<div class="text">
	    						<h2 class="mb-4"><a href="sermon.html">Lord is Sufficient for all of our needs</a></h2>
			  					<div class="meta">
			  						<p>
					...
					<div class="col-lg-6">
						<div class="row no-gutters">
							<div class="col-md-6 ftco-animate">
								<a href="{{ asset('frontend/images/image_1.jpg') }}" class="gallery image-popup img d-flex align-items-center" style="background-image: url({{ url('frontend/images/image_1.jpg') }});">
							...
							<div class="col-md-6 ftco-animate">
								<a href="{{ asset('frontend/images/image_2.jpg') }}" class="gallery image-popup img d-flex align-items-center" style="background-image: url({{ url('frontend/images/image_2.jpg') }});">
									<div class="icon mb-4 d-flex align-items-center justify-content-center">
		    						<span class="icon-instagram"></span>
		    					</div>
								</a>
							...
							<div class="col-md-6 ftco-animate">
								<a href="{{ asset('images/image_3.jpg') }}" class="gallery image-popup img d-flex align-items-center" style="background-image: url({{ url('frontend/images/image_3.jpg') }});">
									<div class="icon mb-4 d-flex align-items-center justify-content-center">
		    						<span class="icon-instagram"></span>
		    					</div>
								</a>
							...
							<div class="col-md-6 ftco-animate">
								<a href="{{ asset('images/image_4.jpg') }}" class="gallery image-popup img d-flex align-items-center" style="background-image: url({{ url('frontend/images/image_4.jpg') }});">
									<div class="icon mb-4 d-flex align-items-center justify-content-center">
		    						<span class="icon-instagram"></span>
		    					</div>
								</a>
